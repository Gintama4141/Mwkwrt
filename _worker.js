...
// Variables
const rootDomain = "mwkwrt.us.kg"; // Ganti dengan domain utama kalian
const serviceName = "aio"; // Ganti dengan nama workers kalian
...
const zoneID = "92794f93c033ae0f47c910603943aefb"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/Gintama4141/Mwkwrt/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Gintama4141/Mwkwrt/refs/heads/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Mwk-Wrt</span>");
